...
public class CustomDrawable extends RefreshDrawable implements Animatable {
    private static final Interpolator LINEAR_INTERPOLATOR = new LinearInterpolator();
    private static final Interpolator END_CURVE_INTERPOLATOR = new CustomDrawable.EndCurveInterpolator();
    private static final Interpolator START_CURVE_INTERPOLATOR = new CustomDrawable.StartCurveInterpolator();
     ...
     */
    private final CustomDrawable.Ring mRing;
    ...
    public CustomDrawable(Context context, PullRefreshLayout parent) {
        super(context, parent);
        mParent = parent;
        mResources = context.getResources();

        mRing = new CustomDrawable.Ring(mCallback);
    ...
    private void createCircleDrawable() {
        ...
        OvalShape oval = new CustomDrawable.OvalShadow(mShadowRadius, diameter);
...
//        ViewCompat.setLayerType(this, ViewCompat.LAYER_TYPE_SOFTWARE, circle.getPaint());
        ...
        mCircle.getPaint().setColor(getContext().getResources().getColor(R.color.background));
    }
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int x = CustomDrawable.this.getBounds().centerX();
            final int y = CustomDrawable.this.getBounds().centerY();
    ...
    private void setSizeParameters(double progressCircleWidth, double progressCircleHeight,
        ...
        final CustomDrawable.Ring ring = mRing;
     ...
     */
    public void updateSizes(@CustomDrawable.ProgressDrawableSize int size) {
        if (size == LARGE) {
